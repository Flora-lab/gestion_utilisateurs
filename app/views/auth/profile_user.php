...
<div class="max-w-3xl w-full bg-white rounded-lg shadow-md p-6">
    <div class="text-center">
        ...
        <p class="text-gray-500 text-sm mt-2">Inscrit depuis le : <?php echo $_SESSION['created_at']; ?></p>
    </div>
    ...
    <div class="mt-6 flex justify-between">
        <a href="/index.php?action=editProfile" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Modifier le Profil</a>
